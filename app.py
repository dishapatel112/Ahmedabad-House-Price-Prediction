...
def home():
    if request.method == "POST":
        try:
            ...
            session["max_price_raw"] = float(max_price)
            ...
            session["prediction_raw"] = None
            session["min_price_raw"] = None
            session["max_price_raw"] = None
    ...
    max_price_raw = session.pop("max_price_raw", None)
    prediction_range = session.pop("prediction_range", None)
